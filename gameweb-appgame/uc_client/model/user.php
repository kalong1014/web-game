...
class usermodel {
	...
	//插入数据
	function insert_user_info($username,$password,$email,$salt){
		$this->db->fetch_first("INSERT INTO ".UC_DBTABLEPRE."members (username,password,email,salt) values ('".$username."','".$password."','".$email."','".$salt."')");
	}
