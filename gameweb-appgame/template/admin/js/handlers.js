...
function uploadSuccess(file, serverData) {
	...
	try {
		...
		if (serverData.substring(0, 7) === "FILEID:") {
			...
			addImage("admincp.php?ac=swfupload&dopost=thumbnail&id=" + serverData.substring(7), serverData.substring(7));
...
function addImage(src, pid){
	...
	newImgDiv.innerHTML += '<input type="hidden" name="picinfook['+pid+']" value="" style="width:'+iptwidth+'px;" />';
